...
<head>
  ...
  <title>Halaman Edit Customer</title>
            ...
            <div class="card">
                <div class="card card-success">
                    <div class="card-header">
                        <h2 class="card-title">Edit Data Customer</h2>
                    </div>
                    <form action="../user/edit.php" method="post">
                    <?php
                        include '../crud/koneksi.php';
                        $code = $_GET['code'];
                        $sql = mysqli_query($koneksi, "SELECT * FROM customers WHERE code='$code' ");
                        $data = mysqli_fetch_assoc($sql);
                      ?>
                        <div class="card-body">
                        <div class="form-group">
                            <label>Kode Customer</label>
                            <input type="text" class="form-control" placeholder="Masukkan Kode Customer" name="code" value="<?= $data['code']; ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label>Nama Customer</label>
                            <input type="text" class="form-control" placeholder="Masukkan Nama Customer" name="name" value="<?= $data['name']; ?>">
                        </div>
                        <div class="form-group">
                            <label>Nomor Telepon</label>
                            <input type="text" class="form-control" placeholder="Masukkan Nomor Telepon" name="phone_number" value="<?= $data['phone_number']; ?>">
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" class="form-control" placeholder="Masukkan Email" name="email" value="<?= $data['email']; ?>">
                        </div>
                        <div class="form-group">
                            <label>Alamat</label><br>
                            <textarea name="address" cols="145" rows="5" placeholder="Masukkan Alamat Lengkap"><?= $data['address']; ?></textarea>
                        </div>
                        <div class="row">
