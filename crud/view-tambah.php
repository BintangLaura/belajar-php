                ...
                <div class="card card-success">
                    ...
                    <form action="../crud/tambah.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan Kode Produk" name="product_code" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan Nama Produk" name="product_name" required>
                        </div>
                        <div class="form-group">
                            <label>Deskripsi Produk</label>
                            <input type="text" class="form-control" placeholder="Masukkan Deskripsi Produk" name="description" required>
                        </div>
                        <div class="form-group">
                            <label>Harga Produk</label>
                            <input type="text" class="form-control" placeholder="Masukkan Harga Produk" name="price" required>
                        </div>
                        <div class="form-group">
                            <label>Diskon Produk</label>
                            <input type="text" class="form-control" placeholder="Masukkan Diskon Produk" name="discount_amount" required>
                        </div>
                        <div class="form-group">
                            <label>Stok Produk</label>
                            <input type="text" class="form-control" placeholder="Masukkan Stok Produk" name="stock" required>
                        </div>
                        <div class="form-group">
