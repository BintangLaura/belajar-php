...
if (isset($_POST['regis'])) {
    $result = $register->registration($_POST['name'], $_POST['username'], $_POST['email'], $_POST['phone_number'], $_POST['password'], $_POST['group_id']);
    ...
    elseif ($result == 10) {
        echo
        "<script> alert('Username telah telah tersedia silahkan login'); </script>";
    }
}
?>
<head>
