<?php 
    $gambar = [
        "../assets/images/kemeja-flanel.jpg", "../assets/images/kemeja-zora.jpg", 
        "../assets/images/basic-sweater.jpg", "../assets/images/kemeja-giovani.jpg", 
        "../assets/images/Kaos-sablon.jpg", "../assets/images/jaket-bomber.jpg",
        "../assets/images/kaos-polos.jpg", "../assets/images/kardigan-rajut.jpg",
    ];

    $nama = [
        "Kemeja Flanel", "Kemeja Pria Zora", "Basic Sweater", "Kemeja Giovani",
        "Kaos Sablon Pantai", "Jaket Bomber", "Kaos Polos", "Kardigan Rajut",
    ];

    $harga = [
        "Rp. 89.000,-", "Rp. 59.000,-", "Rp. 40.000,-", "Rp. 35.000,-", "Rp. 25.000,-", "Rp. 125.000,-", "Rp. 25.000,-", "Rp. 50.000,-",
    ];
?>
...
<head>
  ...
  <title>Halaman Daftar Produk Dengan Bootstrap dan PHP</title>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            <div class="card">
              <div class="card-body">
                <img src="<?php echo $gambar[0]?>" alt="Kemeja Flanel" width="100%">

                <h4 class="text-center mt-2"><?php echo $nama[0]?></h4>
                <h5 class="text-center mt-2"><?php echo $harga[0]?></h5>
          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-body">
                <img src="<?php echo $gambar[1]?>" alt="Kemeja Flanel" width="100%">

                <h4 class="text-center mt-2"><?php echo $nama[1]?></h4>
                <h5 class="text-center mt-2"><?php echo $harga[1]?></h5>
          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-body">
                <img src="<?php echo $gambar[2]?>" alt="Kemeja Flanel" width="100%">

                <h4 class="text-center mt-2"><?php echo $nama[2]?></h4>
                <h5 class="text-center mt-2"><?php echo $harga[2]?></h5>
          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-body">
                <img src="<?php echo $gambar[3]?>" alt="Kemeja Flanel" width="100%">

                <h4 class="text-center mt-2"><?php echo $nama[3]?></h4>
                <h5 class="text-center mt-2"><?php echo $harga[3]?></h5>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="card">
              <div class="card-body">
                <img src="<?php echo $gambar[4]?>" alt="Kemeja Flanel" width="100%">

                <h4 class="text-center mt-2"><?php echo $nama[4]?></h4>
                <h5 class="text-center mt-2"><?php echo $harga[4]?></h5>
          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-body">
                <img src="<?php echo $gambar[5]?>" alt="Kemeja Flanel" width="100%">

                <h4 class="text-center mt-2"><?php echo $nama[5]?></h4>
                <h5 class="text-center mt-2"><?php echo $harga[5]?></h5>
          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-body">
                <img src="<?php echo $gambar[6]?>" alt="Kemeja Flanel" width="100%">

                <h4 class="text-center mt-2"><?php echo $nama[6]?></h4>
                <h5 class="text-center mt-2"><?php echo $harga[6]?></h5>
          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-body">
                <img src="<?php echo $gambar[7]?>" alt="Kemeja Flanel" width="100%">

                <h4 class="text-center mt-2"><?php echo $nama[7]?></h4>
                <h5 class="text-center mt-2"><?php echo $harga[7]?></h5>
